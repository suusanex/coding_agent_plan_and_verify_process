...
| --- | --- | --- | --- | --- | --- | --- |
| `SL-002` | ReadyForSliceDecomposition | Slice Architecture artifact | `plans/pcf-001-slice-architecture.md` at pcf-001-readiness-v1 | consumer gate and production binding conform to approved boundary | Match | proceed to Adaptive Implementation |
...
- `plans/pcf-001-slice-SL-002.md` (bounded Plan)
- `plans/pcf-001-change-risk-triage.md`
- `plans/pcf-001-slice-SL-002-runtime-contract-kernel.md`
- `plans/pcf-001-slice-SL-002-test-design-kernel.md`
...
- `plans/pcf-001-slice-SL-001-verification-kernel.md`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| See: `plans/pcf-001-coverage-ledger.md` | canonical reference | classified | `SL-002` | `RC-002` | `TP-002`, `TP-003` | `XC-001` | none |

## Coverage Ledger Delta

| Delta ID | Source artifact | Plan item / Case ID / Residual ID | Previous status | New status | Evidence / reason | Blocking? |
| --- | --- | --- | --- | --- | --- | --- |
| `DELTA-HO-SL2` | this handoff | `FR-002`, `AC-001`, `AC-002`, `CASE-001`, `CASE-002`, `XC-001` | ReadyForImplementationHandoff | ReadyForImplementation | `SL-001=PARENT_PLAN_VERIFIED`, artifacts complete, architecture Match | No |

## Behavior Case Coverage Ledger

| Case ID | Source IDs | FR / AC | Coverage route | Slice / RC / TP | Status | Residual / reason |
| --- | --- | --- | --- | --- | --- | --- |
| `CASE-001` | PCF-001 behavior spec | `FR-002`, `AC-001` | automated production verifier | `SL-002` / `RC-002` / `TP-002` | ReadyForImplementation | none |
| `CASE-002` | PCF-001 behavior spec | `FR-002`, `AC-002` | automated rejection verifier | `SL-002` / `RC-002` / `TP-003` | ReadyForImplementation | none |

## 欠落または不一致のマッピング

| Plan item | Slice ID | Cross-slice Contract ID | Runtime Contract ID | Test Point ID | Issue |
| --- | --- | --- | --- | --- | --- |
| none | `SL-002` | `XC-001` | `RC-002` | `TP-002`, `TP-003` | None |
...
- Source artifacts: parent and bounded Plans, triage, decomposition, readiness, architecture, runtime contract, test design, canonical ledger, `SL-001` verification
- Coverage ledger source: `plans/pcf-001-coverage-ledger.md`
- Selected contracts / IDs: `SL-002`, `RC-002`, `TP-002`, `TP-003`, `XC-001`, `CASE-001`, `CASE-002`
- Files inspected: planning artifacts and previous slice verdict
...
- Do not redo unless new evidence appears: mapping, dependency, and current-baseline Match
