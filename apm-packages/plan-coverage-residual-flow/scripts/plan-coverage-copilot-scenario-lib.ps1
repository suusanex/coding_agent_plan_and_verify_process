# Shared Copilot scenario helpers for #106 qualification and #107 plugin PoC.
# Dot-source after setting $packageRoot, $repoRoot, fixture roots, and agent name arrays.
# Does not execute scenarios by itself.
...
function Add-ObservedAgent([System.Collections.Generic.List[string]]$Observed, [string]$Text) {
    ...
    # Copilot plugin-qualified agent ids: plugin-name:agent-name
