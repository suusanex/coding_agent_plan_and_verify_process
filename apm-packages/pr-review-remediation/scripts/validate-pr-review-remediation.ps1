...
Assert-Contains '.github/workflows/validate-pr-review-remediation.yml' 'python -m pip install "apm-cli==\$\{\{\s*matrix\.apm-version\s*\}\}"' 'Windows legacy APM pip installation'
