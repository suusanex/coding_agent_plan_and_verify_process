...
Assert-Contains $skill '(?m)^description:\s*Use only when the user explicitly requests Adaptive Implementation Execution' 'skill description explicit-request-only contract'
...
Assert-Contains $skill '利用者が Adaptive Implementation Execution を明示的に要求した場合だけ使用する' 'skill body explicit-request-only rule'
Assert-Contains $skill '「実装して」「このPlanを実装して」などの実装依頼だけでは選択しない' 'skill body rejects plain implementation requests'
...
Assert-Contains 'apm-packages/adaptive-implementation-execution/README.md' '明示指定した場合だけ起動.*「実装して」だけでは自動選択しません' 'documented skill explicit-only selection'
...
Assert-Contains 'apm-packages/adaptive-implementation-execution/docs/usage-guide.md' '利用者が Adaptive Implementation Execution を明示指定した場合だけ選択' 'documented explicit-only skill selection'
Assert-Contains 'apm-packages/adaptive-implementation-execution/docs/usage-guide.md' '「実装して」「このPlanを実装して」だけでは選択しません' 'documented plain implementation non-selection'
...
Assert-Contains 'apm-packages/adaptive-implementation-execution/docs/install-guide.md' '利用者が Adaptive Implementation Execution を明示指定した場合だけ選択' 'install-guide explicit-only skill selection'
Assert-Contains 'apm-packages/adaptive-implementation-execution/docs/install-guide.md' '「実装して」「このPlanを実装して」だけでは選択されません' 'install-guide plain implementation non-selection'
...
Assert-Contains $copilotManualSmoke '(?s)\$adaptive-implementation-execution を使って.*明示起動' 'manual explicit Adaptive skill invocation check'
