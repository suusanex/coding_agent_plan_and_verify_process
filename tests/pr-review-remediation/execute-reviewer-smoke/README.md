...
Records are written under this directory and should include CLI version, requested/observed model, repository revision, input summary, command shape without secrets, raw artifact presence, exit/timeout result, and adapter limitations.
