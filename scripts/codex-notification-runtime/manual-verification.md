...
- Coverage: event/schema、status保持、terminal-envelope gating、dedup、provider failure/timeout/retry、結果／現在taskのdual-button contract、既存notify転送、installer install/check/reinstall/rollback、TOML table挿入、File-based apps publish
